...
SANDBOX_VOLUMES="/localdisk/minminho/openhands:/workspace:rw"
...
docker run -it \
    ...
    python -m openhands.core.main -t "write a bash script that prints hi" -n $session_id --config-file $config_file
